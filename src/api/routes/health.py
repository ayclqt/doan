...
@get("/health/detailed", status_code=HTTP_200_OK)
async def detailed_health_check() -> Dict:
    ...
    try:
        ...
        try:
            ...
            services_status["langchain_pipeline"] = f"unhealthy: {str(e)}"
...
@get("/health/ready", status_code=HTTP_200_OK)
async def readiness_check() -> Dict:
    ...
    try:
        ...
        try:
            ...
            checks["vector_store"] = f"not ready: {str(e)}"
            ready = False
        ...
        try:
            ...
            checks["llm_config"] = f"not ready: {str(e)}"
            ready = False
...
@get("/health/live", status_code=HTTP_200_OK)
